...
// *********
    ...
    @InitiatingFlow
    @StartableByRPC
    class RentAgrCreateFlow(val rentAgrState: RentAgrState): FlowLogic<SignedTransaction> (){
    ...
    @InitiatedBy(RentAgrCreateFlow::class)
    class RentAgrCreateFlowResponder(val counterpartySession: FlowSession) : FlowLogic<Unit>() {
